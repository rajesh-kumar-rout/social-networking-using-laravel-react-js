...
export default function ProfileIndexPage() {
    ...
    async function handleToggleLike(postId) {
        ...
        newPosts[index].totalLikes = newPosts[index].isLiked == "1" ? newPosts[index].totalLikes - 1 : newPosts[index].totalLikes + 1

        newPosts[index].isLiked = newPosts[index].isLiked == "0" ? "1" : "0"
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white border-2 border-x-0 md:border-x-2 border-gray-300 md:rounded-md">
                    ...
                    <div className="space-y-4 p-4">
                        ...
                        <div className="flex items-center gap-4 text-gray-700">
                            <MdSchedule size={24} />
                            <p className="text-gray-600">Joined on {moment(user.updatedAt).format("D MMM YYYY")}</p>
                        </div>
                        ...
                        {user.birthDate && (
                            <div className="flex items-center gap-4 text-gray-700">
                                ...
                                <p className="text-gray-600">Birth Day - {moment(user.birthDate).format("D MMM YYYY")}</p>
                            </div>
                        )}
                    </div>
                </div>
